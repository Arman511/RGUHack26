...
export const FailMeter: React.FC<FailMeterProps> = ({ value }) => {
  ...
  const status =
    value <= -11 ? "CRITICAL" :
    value <= 11 ? "NEUTRAL" : "EXCELLENT";

  const statusColor =
    value <= -11 ? "hsl(0, 70%, 50%)" :
    value <= 11 ? "hsl(45, 90%, 50%)" :
    "hsl(120, 60%, 40%)";

  return (
    <div className="xp-window" style={{ width: 276, background: "hsl(213,71%,53%)" }}>
      ...
      >
        ...
        <div
          style={{
            border: "2px solid",
            borderColor: "hsl(220,10%,60%) hsl(0,0%,95%) hsl(0,0%,95%) hsl(220,10%,60%)",
            background: "hsl(210,20%,96%)",
            padding: 8,
          }}
        >
          ...
          <div
            style={{
              background: "linear-gradient(90deg, hsl(213,72%,44%), hsl(213,50%,62%))",
              borderRadius: 2,
              padding: "2px 8px",
              marginBottom: 6,
          ...
          <svg width="260" height="150" viewBox="0 0 260 150" style={{ display: "block" }}>
            <defs>
              ...
              <linearGradient id="arcGrad" x1={cx - r} y1="0" x2={cx + r} y2="0" gradientUnits="userSpaceOnUse">
            ...
            />
            {/* Needle hub */}
            <circle cx={cx} cy={cy} r="8" fill="hsl(220,10%,30%)" stroke="hsl(220,10%,50%)" strokeWidth="1.5" />
            <circle cx={cx} cy={cy} r="4" fill="hsl(220,10%,45%)" />

            {/* Labels */}
            <text x="12" y="130" fontSize="9" fontWeight="bold" fill="hsl(0,65%,48%)" fontFamily="Tahoma, sans-serif">
              🔥 FIRED
            </text>
            <text x="248" y="130" textAnchor="end" fontSize="9" fontWeight="bold" fill="hsl(120,60%,38%)" fontFamily="Tahoma, sans-serif">
              PROMOTED 🏆
            </text>
          </svg>
          ...
          <div
            style={{
              border: "2px solid",
              borderColor: "hsl(220,10%,60%) hsl(0,0%,100%) hsl(0,0%,100%) hsl(220,10%,60%)",
              background: "white",
              padding: "3px 8px",
              display: "flex",
          ...
          >
            ...
            <span style={{ fontWeight: "bold", color: statusColor }}>{status}</span>
